...
COMPONENT_FILES	:= sobel_edge_detection.sv calculateCompBuffer.sv controller.sv grayscale.sv outputBuffer.sv preGrayScale.sv sobel_controller.sv sobel_edge.sv window_slider.sv flex_stp_sr.sv flex_counter.sv avalonMasterFSM.sv avalonSlaveFSM.sv

# Specify the name of the top level file (do not include the source folder in the name)
# NOTE: YOU WILL NEED TO SET THIS VARIABLE'S VALUE WHEN WORKING WITH HEIRARCHICAL DESIGNS
# AND THE AUTOMATED GRADING SYSTEM
TOP_LEVEL_FILE	:= avalonBus.sv 
